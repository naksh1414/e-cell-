...
function ContactUs() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_hznzkvb", "template_jjl6ism", form.current, {
        publicKey: "j6sb-B3bWAXahc1ZW",
      })
      .then(
        () => {
          console.log("SUCCESS!");
  ...
  return (
    <div className="flex flex-col justify-center items-center text-white pt-28 w-full bg-white dark:bg-black">
      <div className="flex flex-col lg:flex-row w-[100%] lg:w-[80%] justify-center items-center">
        <div className="w-full flex justify-center items-center lg:mr-8">
          <Lottie
            animationData={mail}
            loop={true}
            autoplay
            ...
            >
              <div className="flex w-[90%] flex-row lg:w-full ">
                <div className="flex flex-col lg:w-full">
                  ...
                  <input
                    ...
                    className="bg-transparent !border-0 !border-b-2 !rounded-none !border-b-[#646464] dark:!border-b-white"
                  />
                </div>
              ...
              <div className="w-[50%] lg:w-full mb-8">
                <input
                  ...
                  className={`w-full rounded-lg  py-2 mt-5 cursor-pointer`}
                  id="submitBtn"
                />
              </div>
            </form>

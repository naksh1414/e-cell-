...
import lot1 from "../../assets/Discover/video1.json";
import lot2 from "../../assets/Discover/vid.json";
import "./vision.css";
  ...
  return (
    <div className="flex text-white flex-col items-center justify-center pb-8">
      <motion.div
        ...
        initial="hidden"
        whileInView={"show"}
        className="containerr flex flex-col md:flex-row justify-center items-center md:justify-evenly "
      >
